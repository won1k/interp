...
with open('enc_ptb_results_noise5_train_words.txt','w') as f:
	train = h5py.File('enc_ptb_results_noise5_train.hdf5', 'r')
...
with open('enc_ptb_results_noise5_valid_words.txt','w') as f:
	test = h5py.File('enc_ptb_results_noise5_valid.hdf5', 'r')
