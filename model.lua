...
cmd:option('-data_file','convert/datanew.hdf5','data directory. Should contain data.hdf5 with input data')
cmd:option('-val_data_file','convert/datanewtest.hdf5','data directory. Should contain data.hdf5 with input data')
